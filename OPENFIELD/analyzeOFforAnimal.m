function [meanSpeeds maxSpeeds locoTimes totalDistancesLocomoting, meanSpeedsLocomoting] = analyzeOFforAnimal(dataFolder, EXPID, SAMPLEID, FRAMERATE, PIXELSIZE, MAKEPLOTS )
